...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'faucet_db'),
        'USER': os.environ.get('POSTGRES_USER', 'faucet_user'),
...
RPC = os.environ.get('RPC', 'https://1rpc.io/sepolia')
FAUCET_PRIVATE_KEY = os.environ.get('FAUCET_PRIVATE_KEY')
TIMEOUT_SECONDS = int(os.environ.get('FAUCET_TIMEOUT', 60))
AMOUNT_ETH = 0.0001
...
# You can also place your beat schedule here if you prefer:
